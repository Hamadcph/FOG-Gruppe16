<%-- 
    Document   : LoginScreenEmplooyee
    Created on : 24-05-2019, 00:52:28
        ...
        <header>
            ...
            <ul>
                ...
                <li><a> <i class="fas fa-car"></i> Carporte </a>
                     <ul>
                         <li><a href="carporte.jsp"> Vores carporte</a></li>
                    </ul>
                </li>
                <li><a href="#"><i class="fas fa-briefcase"></i>Jobs </a></li>
                <li><a> <i class="fas fa-car"></i> Bestillinger </a>
                     <ul>
                         <li><a href="/FOG/FrontController?command=requests"> Se ordre</a></li>
                    </ul>
                </li> 
            </ul>
            </div>
